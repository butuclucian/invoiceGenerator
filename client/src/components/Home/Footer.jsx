...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-[#1E1E1E] text-[#E8E8E8] rounded-t-[3rem] md:rounded-t-[4rem] mt-20 px-6 md:px-12 pt-24 pb-8 overflow-hidden relative selection:bg-[#E8E8E8] selection:text-[#1E1E1E]">
      <div className="max-w-9xl mx-auto flex flex-col">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-12 border-b border-white/20 pb-16">
          ...
          <div className="w-full lg:w-auto flex flex-col gap-4">
            <Link to="/register" className="inline-flex items-center justify-center bg-[#E8E8E8] text-[#1E1E1E] px-10 py-5 rounded-full font-black uppercase tracking-widest text-sm hover:bg-purple-400 hover:text-white transition-all duration-300 shadow-[0_0_40px_rgba(232,232,232,0.1)] hover:scale-105">
              Start Creating Free
            </Link>
          </div>
        </div>
