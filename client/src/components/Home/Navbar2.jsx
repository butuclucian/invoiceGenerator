    ...
    <>
      ...
      >
              ...
              >
                <div
                  className={`absolute inset-0 transition-transform duration-300 origin-bottom -z-10 ${
                    isActive
                      ? "bg-[#1E1E1E] scale-y-100"
                      : "bg-[#1E1E1E] scale-y-0 group-hover:scale-y-100"
                  }`}
                />
                <span
                  className={`relative z-10 transition-colors duration-300 ${isActive ? "text-[#E8E8E8]" : "group-hover:text-[#E8E8E8]"}`}
                >
                  {link.name}
                </span>
              </Link>
        ...
        <div className="flex-none flex items-center border-l-2 border-[#1E1E1E] h-full ml-auto lg:ml-0">
          ...
          >
            <span
              className={`w-6 h-0.5 bg-[#1E1E1E] group-hover:bg-[#E8E8E8] transition-all duration-300 ${mobileMenuOpen ? "rotate-45 translate-y-2" : ""}`}
            ></span>
            <span
              className={`w-6 h-0.5 bg-[#1E1E1E] group-hover:bg-[#E8E8E8] transition-all duration-300 ${mobileMenuOpen ? "opacity-0" : "opacity-100"}`}
            ></span>
            <span
              className={`w-6 h-0.5 bg-[#1E1E1E] group-hover:bg-[#E8E8E8] transition-all duration-300 ${mobileMenuOpen ? "-rotate-45 -translate-y-2" : ""}`}
            ></span>
