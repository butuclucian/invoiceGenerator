      ...
      <div className='min-h-screen flex items-center justify-center flex-col mr-5 ml-5'>
        ...
        <div className='w-full mt-2 m-5 pb-9 bg-[#1E1E1E] rounded-4xl overflow-hidden relative'>
          ...
          <motion.div animate={{ y: menuOpen ? 700 : 0 }} transition={{ duration: 0.5 }}>
            <img src="INV.png" alt="" className='absolute right-65 bottom-165 rotate-330 opacity-45' />
            <img src="Ellipse.png" alt="" className='absolute left-370 top-0' />
        ...
        <div className='w-full overflow-x-hidden overflow-y-hidden relative'>
          ...
          <motion.div initial={{ opacity: 0, filter: "blur(10px)", y: 20 }} whileInView={{ opacity: 1, filter: "blur(0px)", y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }} viewport={{ once: true }} className="text-center relative flex flex-col items-center justify-center min-h-[250px]">
            ...
            <motion.h2 className="relative z-10 font-extrabold text-9xl text-black uppercase tracking-[-10%] bottom-20" >
              CHOOSE THE TEMPLATE
            </motion.h2>

            <motion.h3 className="relative bottom-17" >
              Start creating your professional invoices
            </motion.h3>
          </motion.div>

          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-10 max-w-[1600px] mx-auto bottom-15">
            <img src="/INVTEMP1.png" alt="" className="w-400 h-auto rounded-lg shadow-md hover:scale-105 transition-transform hover:cursor-pointer" />
            <img src="/INVTEMP2.png" alt="" className="w-400 h-auto rounded-lg shadow-md hover:scale-105 transition-transform hover:cursor-pointer" />
            <img src="/INVTEMP3.png" alt="" className="w-400 h-auto rounded-lg shadow-md hover:scale-105 transition-transform hover:cursor-pointer" />
            <img src="/INVTEMP2.png" alt="" className="w-400 h-auto rounded-lg shadow-md hover:scale-105 transition-transform hover:cursor-pointer" />
            <img src="/INVTEMP3.png" alt="" className="w-400 h-auto rounded-lg shadow-md hover:scale-105 transition-transform hover:cursor-pointer" />
            <img src="/INVTEMP1.png" alt="" className="w-400 h-auto rounded-lg shadow-md hover:scale-105 transition-transform hover:cursor-pointer" />
          ...
          <img src="/INVBLACK.png" alt="" className='absolute bottom-40 rotate-330 right-360 z-0' />
          <img src="/INVBLACK.png" alt="" className='absolute bottom-200 rotate-300 left-350 z-0' />

          <div className="flex justify-center mb-20">
            <button onClick={()=> navigate("/invoice-template")} className='bg-[#1E1E1E] text-white px-8 py-4 font-extrabold rounded-2xl'>
        ...
        <div className='w-full mt-2 m-5 min-h-screen bg-[#1E1E1E] rounded-4xl overflow-hidden relative'>
          ...
          <motion.div initial={{ opacity: 0, filter: "blur(10px)", y: 20 }} whileInView={{ opacity: 1, filter: "blur(0px)", y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }} viewport={{ once: true }} className="flex flex-col items-center justify-center text-center w-full overflow-hidden  mt-10" >
            <motion.h1 className="text-[160px] text-white font-extrabold leading-none tracking-[-10%] mt-2" >
              HOW IT WORKS
            </motion.h1>
            ...
            <motion.h3 className="relative text-white left-150 text-3xl bottom-10 -rotate-10 font-handwriting" >
              by invoiceGenAi
            </motion.h3>
          </motion.div>
          ...
          <div className='overflow-hidden h-[1200px] z-10 relative'>
            ...
            <div className='relative left-10'>
              <div className='relative bg-[#D9D9D9]/40 w-150 h-130 rounded-3xl backdrop-blur-sm z-10 flex items-center justify-center shadow-2xl border border-white/20 left-25 bottom-0'>
            ...
            {/* step 2 */}
            <div className='relative left-270 bottom-212'>
              <div className='relative bg-[#D9D9D9]/40 w-150 h-130 rounded-3xl backdrop-blur-sm z-10 flex items-center justify-center shadow-2xl border border-white/20 left-25 bottom-0'>
                <h1 className='text-white font-light text-7xl text-right px-4 w-full max-w-[420px] ml-auto translate-x-3 translate-y-45'>
                  ADD YOUR CLIENTS
                </h1>
            ...
            {/* step 3 */}
            <div className='relative left-145 bottom-280'>
              <div className='relative bg-[#D9D9D9]/40 w-150 h-130 rounded-3xl backdrop-blur-sm z-10 flex items-center justify-center shadow-2xl border border-white/20 left-25 bottom-0'>
                <h1 className='text-white font-light text-7xl text-right px-4 w-full max-w-[420px] ml-auto translate-x-3 translate-y-45'>
                  GENERATE INVOICES
                </h1>
          ...
          <img src="/INV.png" alt="" className='absolute left-300 bottom-0 rotate-330 z-0 opacity-40' />

          <img src="/INV.png" alt="" className='absolute right-300 top-5 rotate-330 z-0 opacity-40' />
        ...
        <div className='w-full overflow-x-hidden overflow-y-hidden relative min-h-screen'>
          ...
          <motion.div initial={{ opacity: 0, filter: "blur(10px)", y: 20 }} whileInView={{ opacity: 1, filter: "blur(0px)", y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }} viewport={{ once: true }} className="text-center relative flex flex-col items-center justify-center min-h-[250px]" >
            ...
            <motion.h3 className="relative bottom-15" >
              Simple pricing on your needs
            </motion.h3>
          </motion.div>

          {/* pricing cards */}
          <h1 className="text-6xl font-bold text-black text-center pb-10 tracking-[-10%]">COMING SOON!</h1>
          <h1 className="text-6xl font-bold text-black text-center pb-10 tracking-[-10%]">COMING SOON!</h1>
          <h1 className="text-6xl font-bold text-black text-center pb-10 tracking-[-10%]">COMING SOON!</h1>
          <h1 className="text-6xl font-bold text-black text-center pb-10 tracking-[-10%]">COMING SOON!</h1>
          <h1 className="text-6xl font-bold text-black text-center pb-10 tracking-[-10%]">COMING SOON!</h1>
        ...
        <div className='flex justify-between gap-280'>
          <p className='mb-3 flex'>designed and built with<span className='ml-1 mr-1'> <Heart/> </span>  by invoiceGenAi.</p>
          <p className='mb-3'>© 2026 invoiceGenAi. all rights reserved.</p>
        </div>
