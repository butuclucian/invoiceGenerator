...
const invoiceSchema = new mongoose.Schema(
  {
    ...
    due_date: { type: Date },
    status: { type: String, enum: ["pending", "draft", "sent", "paid", "overdue"], default: "draft"},
    ...
    payment_method: { type: String,  enum: ["cash", "card", "bank_transfer", "not_paid", "stripe"], default: "not_paid" },
